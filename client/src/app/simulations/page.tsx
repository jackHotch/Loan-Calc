...
import { payoffStrategies, strategyColors, strategyDisplayNames } from '@/constants/constants'
    ...
    <div className='p-4 sm:p-6 lg:p-8 flex flex-col gap-6 lg:gap-8'>
      <header className='w-full flex justify-between items-end'>
        <div className='flex flex-col gap-2'>
          <p className='text-label mb-1 sm:mb-4'>All Simulations</p>
          <h1 className='font-display text-3xl sm:text-5xl font-light'>Simulations</h1>
      ...
      <div className='flex justify-between items-center border-b border-b-muted-foreground/50 mt-4 lg:mt-8 pb-2'>
        {/* Mobile/tablet: compact select */}
          ...
          <Select value={filter} onValueChange={setFilter}>
            ...
            <SelectContent>
              <SelectGroup>
                ...
                {Object.entries(strategyDisplayNames).map(([value, label]) => (
            ...
            <div key={key}>
              <div className='card flex-col gap-2'>
                <div className='w-full flex justify-between'>
                  ...
                  <div className='flex flex-wrap gap-4 lg:gap-8 justify-end'>
                    <div>
                ...
                <div className='flex flex-wrap gap-2 w-full text-xs mt-4'>
